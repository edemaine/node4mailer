...
class MailMessage {
    ...
    resolveContent(/*...args*/) {
        return shared.resolveContent.apply(null, arguments);
    }
    ...
    resolveAll(callback) {
        ...
        let resolveNext = () => {
            ...
            shared.resolveContent.apply(null, args.concat([(err, value) => {
                if (err) {
                    return callback(err);
                }
                ...
                if (args[0][args[1]] && typeof args[0][args[1]] === 'object' && !Buffer.isBuffer(args[0][args[1]])) {
                    Object.keys(args[0][args[1]]).forEach(key => {
                        if (!(key in node) && !includes(['content', 'path', 'href', 'raw'], key)) {

...
class MimeNode {
    ...
    getTransferEncoding() {
        ...
        if (this.content) {
            ...
            if (!transferEncoding || !includes(['base64', 'quoted-printable'], transferEncoding)) {
    ...
    buildHeaders() {
        ...
        this._headers.forEach(header => {
            ...
            if (value && typeof value === 'object' && !includes(formattedHeaders, key)) {
        ...
        let sendContent = () => {
            if (this.content) {
                ...
                let createStream = () => {
                    ...
                    if (includes(['quoted-printable', 'base64'], transferEncoding)) {
    ...
    setEnvelope(envelope) {
        ...
        Object.keys(envelope).forEach(key => {
            if (!includes(standardFields, key)) {
    ...
    getAddresses() {
        ...
        this._headers.forEach(header => {
            ...
            if (includes(['from', 'sender', 'reply-to', 'to', 'cc', 'bcc'], key)) {
    ...
    getEnvelope() {
        ...
        this._headers.forEach(header => {
            let list = [];
            if (header.key === 'From' || (!envelope.from && includes(['Reply-To', 'Sender'], header.key))) {
                this._convertAddresses(this._parseAddresses(header.value), list);
                if (list.length && list[0]) {
                    envelope.from = list[0].address;
                }
            } else if (includes(['To', 'Cc', 'Bcc'], header.key)) {
